...
//                                    'class' => 'radionButton',
                ...
                <div class="col-sm-12" style="margin-top: 1.5rem; font-size: 1.8rem;">
                    <?= $form->field($model, 'type_for_total')->checkboxList(
                        [
                            1 => 'опубликована в инормационной базе Thomson Reuters',
                            2 => 'опубликована в базе Scopus',
                            3 => 'опубликована в рецензируемых журналах на Английском/Немецком/Французком языках',
                            4 => 'опубликована в ККСОН МОН РК',
                        ],
                        [
                            'separator' => '<br>',
                        ]
                    )->label('Статус публикации для подчета гонорара:'); ?>
                </div>
